// Campbell Cashflow – RemoteArticle (self-contained Framer component)
// Framer: Assets > Code > New File > paste > Save > drag onto canvas
// Fetches article JSON from a url prop and renders the full article page.
//
...
function StepBlock({ step, i, m }: { step: Step; i: number; m: boolean }) {
  return (
    <div
      style={{
        ...box,
...
function ArticleLayout(props: ArticleProps) {
  ...
  return (
    <div style={{ ...box, overflowX: "hidden", background: c.white }}>
      ...
      {/* Steps label */}
      <div
        style={{ ...box, padding: m ? "24px 24px 14px" : "32px 80px 16px" }}
      >
        <div
          style={{
            display: "flex",
      ...
      {/* CTA */}
      <div
        style={{ ...box, padding: m ? "24px 24px 56px" : "36px 80px 80px" }}
      >
        <div
          style={{
            ...box,
...
/* ── RemoteArticle (default export) ────────────────────── */

export default function RemoteArticle({ url }: { url: string }) {
